    ...
    public class DiplomataCharacter : DiplomataTalkable
    {
        ...
        public List<string> MessageChoices()
        {
            ...
            if (choices.Count > 0)
            {
                ...
                {
                    var content = DictionariesHelper
                        .ContainsKey(choice.content, DiplomataManager.Data.options.currentLanguage).value;
        ...
        public void ChooseMessage(string content)
        {
            ...
            if (currentColumn != null)
            {
                ...
                {
                    var localContent = DictionariesHelper
                        .ContainsKey(msg.content, DiplomataManager.Data.options.currentLanguage).value;
        ...
        public byte SetInfluence()
        {
            ...
            if (currentMessage != null)
            {
                ...
                var tempInfluence = (max + character.influence) / 2;
