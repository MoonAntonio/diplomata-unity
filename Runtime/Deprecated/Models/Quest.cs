...
namespace LavaLeak.Diplomata.Models
{
    ...
    public class Quest : Data
    {
        ...
        public bool IsActive() => Initialized && !finished;

        /// <summary>
        /// Get if the quest is complete.
        /// </summary>
        /// <returns>Return true if is complete or false.</returns>
        public bool IsComplete() => Initialized && finished;
        ...
        public bool IsQuestStateCompleteById(string id)
        {
            ...
            for (var i = 0; i < allQuestStates.Count; i++)
            {
        ...
        /// <returns>The name as string.</returns>
        public string GetName(Options options) => GetName(options.currentLanguage);
        ...
        {
            var questsReturn = quests == null ? new string[0] : new string[quests.Length];
            if (quests != null)
            {
        ...
        /// <param name="options">The options to get current language.</param>
        /// <returns></returns>
        public static string[] GetNames(Quest[] quests, Options options) => GetNames(quests, options.currentLanguage);
        ...
        public override string ToString()
        {
            ...
            foreach (var state in GetQuestLog())
            {
        ...
        public string GetStateByIndex(int index, string language = "") =>
            index < questStates.Length ? questStates[index].GetShortDescription(language) : string.Empty;
