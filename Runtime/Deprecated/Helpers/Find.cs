...
namespace LavaLeak.Diplomata.Helpers
{
    ...
    public static class Find
    {
        ...
        public static Subject In(object[] collection) => new Subject(collection);
    }
    ...
    public class Subject
    {
        ...
        {
            get => _results.Count < 1 ? new object[0] : _results.ToArray();
            private set
            {
        ...
        {
            get => Results.Length >= 1 ? Results[0] : null;
            private set => _results[0] = value;
        }
