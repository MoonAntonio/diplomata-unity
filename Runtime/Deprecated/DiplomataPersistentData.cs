...
namespace LavaLeak.Diplomata
{
    ...
    /// </summary>
    [Serializable]
    public sealed class DiplomataPersistentData
    {
        ...
        public void Load()
        {
            ...
            DiplomataManager.Data.characters = Data
                .SetArrayData<Character>(DiplomataManager.Data.characters.ToArray(), characters).OfType<Character>()
                .ToList();
            DiplomataManager.Data.globalFlags.SetData(globalFlags);
            DiplomataManager.Data.interactables = Data
                .SetArrayData<Interactable>(DiplomataManager.Data.interactables.ToArray(), interactables)
