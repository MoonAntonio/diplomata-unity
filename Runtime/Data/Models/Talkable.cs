...
namespace LavaLeak.Diplomata.Models
{
    ...
    public class Talkable : Data
    {
        ...
        /// </summary>
        public static void UpdateList<TModel, TMono>(string path, ref List<TModel> talkables, ref Options options)
            where TModel : Talkable where TMono : DiplomataTalkable
        {
