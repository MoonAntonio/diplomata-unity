...
namespace LavaLeak.Diplomata.Editor.Windows
{
    public class TalkableMessagesEditor : EditorWindow
    {
        ...
        {
            var window = (TalkableMessagesEditor) GetWindow(typeof(TalkableMessagesEditor), false, "Messages", true);
        ...
        public void DrawContextList()
        {
            ...
            if (talkable != null)
            {
                ...
                for (var i = 0; i < talkable.contexts.Length; i++)
                {
                    var context = Context.Find(talkable, i);

                    var boxRect = EditorGUILayout.BeginVertical(GUIHelper.boxStyle);
                    GUI.Box(boxRect, GUIContent.none);

                    var name = DictionariesHelper.ContainsKey(context.name,
                    ...
                    if (name == null)
                    {
                        context.name = ArrayHelper.Add(context.name,
                            new LanguageDictionary(Controller.Instance.Options.currentLanguage,
                                "Name [Change clicking on Edit]"));
                        name = DictionariesHelper.ContainsKey(context.name,
                            Controller.Instance.Options.currentLanguage);
                    }
                    ...
                    if (GUILayout.Button("Delete", GUILayout.Height(GUIHelper.BUTTON_HEIGHT)))
                    {
                        if (EditorUtility.DisplayDialog("Are you sure?",
                            "All data inside this context will be lost forever.", "Yes", "No"))
                        {
        ...
        {
            talkable.contexts = ArrayHelper.Add(talkable.contexts,
                new Context(talkable.contexts.Length, talkable.name, Controller.Instance.Options.languages));
            Save();
        }
        ...
        public void Main()
        {
            ...
            scrollPosMain =
                EditorGUILayout.BeginScrollView(scrollPosMain, messagesWindowMainStyle, GUILayout.Width(width));
            GUILayout.BeginHorizontal();
            ...
            for (var i = 0; i < context.columns.Length; i++)
            {
                ...
                column.emitter =
                    GUIHelper.Popup("Emitter: ", column.emitter, Controller.Instance.Options.characterList);

                EditorGUILayout.Separator();

                for (var j = 0; j < column.messages.Length; j++)
                {
                    var currentMessage = column.messages[j];
                    ...
                    foreach (var msg in column.messages)
                    {
                        if (msg.id == j)
                        {
                            currentMessage = msg;
                    ...
                    if (label.show)
                    {
                        ...
                        if (context.conditionsFilter)
                        {
                            if (currentMessage.conditions.Length > 0)
                            {
                                ...
                                for (var k = 0; k < currentMessage.conditions.Length; k++)
                                {
                                    ...
                                    switch (condition.type)
                                    {
                                        ...
                                        case Condition.Type.HasItem:
                                            var itemName = "";
                                            if (Item.Find(Controller.Instance.Inventory.items, condition.itemId) !=
                                                null)
                                            {
                                                itemName = DictionariesHelper.ContainsKey(
                                                    Item.Find(Controller.Instance.Inventory.items, condition.itemId)
                                                        .name, Controller.Instance.Options.currentLanguage).value;
                                            }
                                        ...
                                        case Condition.Type.DoesNotHaveTheItem:
                                            ...
                                            if (Item.Find(Controller.Instance.Inventory.items, condition.itemId) !=
                                                null)
                                            {
                                                itemNameDont = DictionariesHelper.ContainsKey(
                                                    Item.Find(Controller.Instance.Inventory.items, condition.itemId)
                                                        .name, Controller.Instance.Options.currentLanguage).value;
                                            }
                                ...
                                GUIHelper.textContent.text = text;
                                height = GUIHelper.labelStyle.CalcHeight(GUIHelper.textContent, context.columnWidth);
                                GUILayout.Label(GUIHelper.textContent, GUIHelper.labelStyle,
                                    GUILayout.Width(context.columnWidth), GUILayout.Height(height));
                                GUIHelper.labelStyle.normal.textColor =
                                    ColorHelper.ColorAdd(GUIHelper.labelStyle.normal.textColor, 0, 0.4f);
                            }
                        ...
                        if (context.contentFilter)
                        {
                            ...
                            var content = DictionariesHelper.ContainsKey(currentMessage.content,
                                Controller.Instance.Options.currentLanguage);
                            ...
                            if (!currentMessage.isAChoice)
                            {
                                ...
                                {
                                    var currentAttachedContent = DictionariesHelper.ContainsKey(attachedContent.content,
                                        Controller.Instance.Options.currentLanguage);
                                    ...
                                    if (currentAttachedContent == null)
                                    {
                                        attachedContent.content = ArrayHelper.Add(attachedContent.content,
                                            new LanguageDictionary(Controller.Instance.Options.currentLanguage,
                                                "[ Message content here ]"));
                                        currentAttachedContent = DictionariesHelper.ContainsKey(attachedContent.content,
                                            Controller.Instance.Options.currentLanguage);
                                    }
                                    ...
                                    currentAttachedContent.value = EditorGUILayout.TextArea(
                                        currentAttachedContent.value, textAreaStyle,
                                    ...
                                    {
                                        if (EditorUtility.DisplayDialog("Are you sure?",
                                            "Do you really want to delete?\nThis content will be lost forever.", "Yes",
                                            "No"))
                                        {
                                ...
                                if (GUILayout.Button("Attach content", GUILayout.Width(context.columnWidth),
                                    GUILayout.Height(GUIHelper.BUTTON_HEIGHT_SMALL)))
                                {
                                    currentMessage.attachedContent = ArrayHelper.Add(currentMessage.attachedContent,
                                        new AttachedContent());
                                }
                            }
                        ...
                        if (context.effectsFilter)
                        {
                            if (currentMessage.effects.Length > 0)
                            {
                                ...
                                for (var k = 0; k < currentMessage.effects.Length; k++)
                                {
                                    ...
                                    switch (effect.type)
                                    {
                                        ...
                                        case Effect.Type.EndOfContext:
                                            if (effect.endOfContext.talkableName != null &&
                                                effect.endOfContext.talkableName != string.Empty)
                                            {
                                                var tempContext = effect.endOfContext.GetContext(
                                                    Controller.Instance.Characters, Controller.Instance.Interactables);
                                                if (tempContext == null)
                                                {
                                                    break;
                                                }

                                                var tempName = DictionariesHelper.ContainsKey(tempContext.name,
                                                    Controller.Instance.Options.currentLanguage);
                                                if (tempName == null)
                                                {
                                                    break;
                                        ...
                                        case Effect.Type.GoTo:
                                            if (effect.goTo.GetMessage(context) != null)
                                            {
                                                text += effect.DisplayGoTo(DictionariesHelper
                                                    .ContainsKey(effect.goTo.GetMessage(context).content,
                                                        Controller.Instance.Options.currentLanguage).value);
                                            }
                                        ...
                                        case Effect.Type.GetItem:
                                            ...
                                            {
                                                itemName = DictionariesHelper.ContainsKey(
                                                    Item.Find(Controller.Instance.Inventory.items, effect.itemId).name,
                                                    Controller.Instance.Options.currentLanguage).value;
                                            }
                                        ...
                                        case Effect.Type.DiscardItem:
                                            ...
                                            if (Item.Find(Controller.Instance.Inventory.items, effect.itemId) != null)
                                            {
                                                discardItemName = DictionariesHelper.ContainsKey(
                                                    Item.Find(Controller.Instance.Inventory.items, effect.itemId).name,
                                                    Controller.Instance.Options.currentLanguage).value;
                                            }
                                        ...
                                        case Effect.Type.EquipItem:
                                            ...
                                            if (Item.Find(Controller.Instance.Inventory.items, effect.itemId) != null)
                                            {
                                                equipItemName = DictionariesHelper.ContainsKey(
                                                    Item.Find(Controller.Instance.Inventory.items, effect.itemId).name,
                                                    Controller.Instance.Options.currentLanguage).value;
                                            }
                                        ...
                                        case Effect.Type.SetQuestState:
                                            text += effect.DisplaySetQuestState(Controller.Instance.Quests,
                                                Controller.Instance.Options.currentLanguage);
                                            break;
                                        case Effect.Type.FinishQuest:
                                            text += effect.DisplayFinishQuest(Controller.Instance.Quests,
                                                Controller.Instance.Options.currentLanguage);
                                            break;
                                        case Effect.Type.StartQuest:
                                            text += effect.DiplayStartQuest(Controller.Instance.Quests,
                                                Controller.Instance.Options.currentLanguage);
                                            break;
                                    }
                        ...
                        if (currentMessage.disposable || currentMessage.isAChoice)
                        {
                            ...
                            if (currentMessage.isAChoice)
                            {
                                    ...
                                    GUILayout.Height(GUIHelper.BUTTON_HEIGHT_SMALL)))
                                {
                                    ...
                                    if (nextColumn == null)
                                    {
                                        context.columns = ArrayHelper.Add(context.columns,
                                            new Column(context.columns.Length, Controller.Instance.Options));
                                        nextColumn = context.columns[context.columns.Length - 1];
                                    }

                                    // Create a new message.
                                    var newMessage = new Message(nextColumn.messages.Length,
                                        Controller.Instance.Options.playerCharacterName, nextColumn.id,
        ...
        public void LabelManager()
        {
            ...
            var height = size.x + 100 + 180 + context.labels.Length * 240 >= position.width
                ? LABEL_HEIGHT
                : HEADER_HEIGHT;

            scrollPosLabelManager = EditorGUILayout.BeginScrollView(scrollPosLabelManager, messagesWindowHeaderStyle,
                GUILayout.Width(position.width), GUILayout.Height(height));
            GUILayout.BeginHorizontal();
        ...
        private void Sidebar()
        {
            ...
            if (message != null)
            {
                switch (context.messageEditorState)
                {
                    case MessageEditorState.Normal:
                        ...
                        if (message.isAChoice)
                        {
                            ...
                            foreach (var attrName in Controller.Instance.Options.attributes)
                            {
                                for (var i = 0; i < message.attributes.Length; i++)
                                {
                                    ...
                                    {
                                        message.attributes = ArrayHelper.Add(message.attributes,
                                            new AttributeDictionary(attrName));
                                    }
                                }
                            ...
                            for (var i = 0; i < message.attributes.Length; i++)
                            {
                                message.attributes[i].value = (byte) EditorGUILayout.Slider(message.attributes[i].key,
                                    message.attributes[i].value, 0, 100);
                            }
                        }
                        ...
                        if (label != null)
                        {
                            for (var labelI = 0; labelI < labelsList.Length; labelI++)
                            {
                        ...
                        var screenplayNotes = DictionariesHelper.ContainsKey(message.screenplayNotes,
                            Controller.Instance.Options.currentLanguage);
                        ...
                        if (screenplayNotes == null)
                        {
                            message.screenplayNotes = ArrayHelper.Add(message.screenplayNotes,
                                new LanguageDictionary(Controller.Instance.Options.currentLanguage, ""));
                            screenplayNotes = DictionariesHelper.ContainsKey(message.screenplayNotes,
                                Controller.Instance.Options.currentLanguage);
                        }
                        ...
                        var audioClipPath = DictionariesHelper.ContainsKey(message.audioClipPath,
                            Controller.Instance.Options.currentLanguage);
                        ...
                        if (audioClipPath == null)
                        {
                            ...
                            audioClipPath = DictionariesHelper.ContainsKey(message.audioClipPath,
                                Controller.Instance.Options.currentLanguage);
                        }
                        ...
                        {
                            Debug.LogWarning(
                                "Cannot find the file \"" + audioClipPath.value + "\" in Resources folder.");
                        }
                        ...
                        message.audioClip =
                            (AudioClip) EditorGUILayout.ObjectField(message.audioClip, typeof(AudioClip), false);
                        ...
                        message.image =
                            (Texture2D) EditorGUILayout.ObjectField(message.image, typeof(Texture2D), false);
                        ...
                        foreach (var animatorAttribute in message.animatorAttributesSetters)
                        {
                            EditorGUILayout.Separator();
                            ...
                            if (EditorGUI.EndChangeCheck())
                            {
                                ...
                                {
                                    var str = AssetDatabase.GetAssetPath(animatorAttribute.animator)
                                        .Replace("Resources/", "¬");
                                    var strings = str.Split('¬');
                            ...
                            switch (animatorAttribute.type)
                            {
                                case AnimatorControllerParameterType.Bool:
                                    var selected = animatorAttribute.setBool.ToString();
                            ...
                            if (GUILayout.Button("Delete Animator Attribute Setter",
                                GUILayout.Height(GUIHelper.BUTTON_HEIGHT_SMALL)))
                            {
                        ...
                        if (GUILayout.Button("Add Animator Attribute Setter",
                            GUILayout.Height(GUIHelper.BUTTON_HEIGHT)))
                        {
                            message.animatorAttributesSetters = ArrayHelper.Add(message.animatorAttributesSetters,
                                new AnimatorAttributeSetter());
                            Save();
                        }
                        ...
                        {
                            column.messages = ArrayHelper.Add(column.messages,
                                new Message(message, column.messages.Length));
                            ...
                            switch (condition.type)
                            {
                                case Condition.Type.AfterOf:
                                    ...
                                    if (condition.afterOf.GetMessage(context) != null)
                                    {
                                        messageName = DictionariesHelper
                                            .ContainsKey(condition.afterOf.GetMessage(context).content,
                                                Controller.Instance.Options.currentLanguage).value;
                                    }
                                    ...
                                    if (EditorGUI.EndChangeCheck())
                                    {
                                        foreach (var col in context.columns)
                                        {
                                            foreach (var msg in col.messages)
                                            {
                                                if (DictionariesHelper.ContainsKey(msg.content,
                                                        Controller.Instance.Options.currentLanguage).value ==
                                                    messageName)
                                                {
                                ...
                                case Condition.Type.InfluenceLessThan:
                                    if (talkable.GetType() == typeof(Character))
                                    {
                                        ...
                                        if (condition.characterInfluencedName == string.Empty &&
                                            characterList.Length > 0)
                                        {
                                            condition.characterInfluencedName = characterList[0];
                                        }

                                        condition.comparedInfluence =
                                            EditorGUILayout.IntField(condition.comparedInfluence);
                                        condition.characterInfluencedName = GUIHelper.Popup(" in ",
                                            condition.characterInfluencedName, characterList);
                                    ...
                                    {
                                        EditorGUILayout.HelpBox("This condition is only valid to a character.",
                                            MessageType.Warning);
                                    }
                                ...
                                case Condition.Type.HasItem:
                                    ...
                                    if (EditorGUI.EndChangeCheck())
                                    {
                                        ...
                                        {
                                            if (DictionariesHelper.ContainsKey(item.name,
                                                    Controller.Instance.Options.currentLanguage).value == itemName)
                                            {
                                ...
                                case Condition.Type.DoesNotHaveTheItem:
                                    ...
                                    if (EditorGUI.EndChangeCheck())
                                    {
                                        ...
                                        {
                                            if (DictionariesHelper.ContainsKey(item.name,
                                                    Controller.Instance.Options.currentLanguage).value == itemNameDont)
                                            {
                                                condition.itemId = item.id;
                                                break;
                                            }
                                ...
                                case Condition.Type.ItemIsEquipped:
                                    ...
                                    if (itemList.Length > 0)
                                    {
                                        equippedItemName = DictionariesHelper.ContainsKey(
                                            Item.Find(Controller.Instance.Inventory.items, condition.itemId).name,
                                            Controller.Instance.Options.currentLanguage).value;
                                    }
                                ...
                                case Condition.Type.ItemWasDiscarded:
                                    ...
                                    discardedItemName = GUIHelper.Popup("Item was discarded ", discardedItemName,
                                        itemList);
                                ...
                                case Condition.Type.GlobalFlagEqualTo:
                                    ...
                                    condition.globalFlag.name = GUIHelper.Popup("Flag: ", condition.globalFlag.name,
                                        globalFlagsList);

                                    var selected = condition.globalFlag.value.ToString();
                                ...
                                case Condition.Type.QuestStateIs:
                                    ...
                                    var questNameDict = quest != null
                                        ? DictionariesHelper.ContainsKey(quest.Name,
                                            Controller.Instance.Options.currentLanguage)
                                        : null;
                                    ...
                                    EditorGUI.BeginChangeCheck();
                                    var questNames = Quest.GetNames(Controller.Instance.Quests,
                                        Controller.Instance.Options);
                                    questNames = ArrayHelper.Add(questNames, string.Empty);
                                    questName = GUIHelper.Popup("Quest: ", questName, questNames);
                                    if (EditorGUI.EndChangeCheck())
                                    {
                                        var questIndex = ArrayHelper.GetIndex(
                                            Quest.GetNames(Controller.Instance.Quests, Controller.Instance.Options),
                                            questName);
                                        if (questIndex > -1)
                                        {
                                            condition.questAndState.questId =
                                                Quest.GetIDs(Controller.Instance.Quests)[questIndex];
                                        }
                                    }

                                    // Get the quest state name.
                                    quest = Quest.Find(Controller.Instance.Quests, condition.questAndState.questId);
                                    var questState = quest != null
                                        ? quest.GetState(condition.questAndState.questStateId)
                                        : null;
                                    var questStateNameDict = questState != null
                                        ? DictionariesHelper.ContainsKey(questState.ShortDescription,
                                            Controller.Instance.Options.currentLanguage)
                                        : null;
                                    var questStateName = questStateNameDict != null
                                        ? questStateNameDict.value
                                        : string.Empty;
                                    ...
                                    if (quest != null)
                                    {
                                        ...
                                        questStateName = GUIHelper.Popup("Quest state: ", questStateName,
                                            questStateNames);
                                        if (EditorGUI.EndChangeCheck())
                                        {
                                            var questStateIndex = ArrayHelper.GetIndex(
                                                QuestState.GetShortDescriptions(quest.questStates,
                                                    Controller.Instance.Options), questStateName);
                                            if (questStateIndex > -1)
                                            {
                                                condition.questAndState.questStateId =
                                                    QuestState.GetIDs(quest.questStates)[questStateIndex];
                                            }
                                        }
                                    }
                                ...
                                case Condition.Type.QuestInitialized:
                                    // Get the quest name.
                                    var questInialized = Quest.Find(Controller.Instance.Quests,
                                        condition.questAndState.questId);
                                    var questInializedNameDict = questInialized != null
                                        ? DictionariesHelper.ContainsKey(questInialized.Name,
                                            Controller.Instance.Options.currentLanguage)
                                        : null;
                                    var questInializedName = questInializedNameDict != null
                                        ? questInializedNameDict.value
                                        : string.Empty;

                                    // Quest name Popup with a change checker.
                                    EditorGUI.BeginChangeCheck();
                                    var questInializedNames = Quest.GetNames(Controller.Instance.Quests,
                                        Controller.Instance.Options);
                                    questInializedNames = ArrayHelper.Add(questInializedNames, string.Empty);
                                    questInializedName = GUIHelper.Popup("Quest: ", questInializedName,
                                        questInializedNames);
                                    if (EditorGUI.EndChangeCheck())
                                    {
                                        var questIndex = ArrayHelper.GetIndex(
                                ...
                                case Condition.Type.QuestFinished:
                                    // Get the quest name.
                                    var questFinished = Quest.Find(Controller.Instance.Quests,
                                        condition.questAndState.questId);
                                    var questFinishedNameDict = questFinished != null
                                        ? DictionariesHelper.ContainsKey(questFinished.Name,
                                            Controller.Instance.Options.currentLanguage)
                                        : null;
                                    var questFinishedName = questFinishedNameDict != null
                                        ? questFinishedNameDict.value
                                        : string.Empty;

                                    // Quest name Popup with a change checker.
                                    EditorGUI.BeginChangeCheck();
                                    var questFinishedNames = Quest.GetNames(Controller.Instance.Quests,
                                        Controller.Instance.Options);
                                    questFinishedNames = ArrayHelper.Add(questFinishedNames, string.Empty);
                                    questFinishedName =
                                        GUIHelper.Popup("Quest: ", questFinishedName, questFinishedNames);
                                    if (EditorGUI.EndChangeCheck())
                                    {
                                        var questIndex = ArrayHelper.GetIndex(
                                            Quest.GetNames(Controller.Instance.Quests, Controller.Instance.Options),
                        ...
                        foreach (var effect in message.effects)
                        {
                            ...
                            switch (effect.type)
                            {
                                case Effect.Type.EndOfContext:
                                    ...
                                    if (effect.endOfContext.talkableName != null)
                                    {
                                        var contextToEnd = effect.endOfContext.GetContext(
                                            Controller.Instance.Characters, Controller.Instance.Interactables);
                                        if (contextToEnd != null)
                                        {
                                            contextName = DictionariesHelper.ContainsKey(contextToEnd.name,
                                                Controller.Instance.Options.currentLanguage).value;
                                        }
                                    }
                                    ...
                                    if (EditorGUI.EndChangeCheck())
                                    {
                                        foreach (var tempCharacter in Controller.Instance.Characters)
                                        {
                                            foreach (var ctx in tempCharacter.contexts)
                                            {
                                                if (DictionariesHelper.ContainsKey(ctx.name,
                                                        Controller.Instance.Options.currentLanguage).value ==
                                                    contextName)
                                                {
                                        ...
                                        foreach (var tempInteractable in Controller.Instance.Interactables)
                                        {
                                            foreach (var ctx in tempInteractable.contexts)
                                            {
                                                if (DictionariesHelper.ContainsKey(ctx.name,
                                                        Controller.Instance.Options.currentLanguage).value ==
                                                    contextName)
                                ...
                                case Effect.Type.SetAnimatorAttribute:
                                    ...
                                    effect.animatorAttributeSetter.animator =
                                        (RuntimeAnimatorController) Resources.Load(effect.animatorAttributeSetter
                                            .animatorPath);

                                    if (effect.animatorAttributeSetter.animator == null &&
                                        effect.animatorAttributeSetter.animatorPath != string.Empty)
                                    {
                                        Debug.LogWarning("Cannot find the file \"" +
                                                         effect.animatorAttributeSetter.animatorPath +
                                                         "\" in Resources folder.");
                                    }
                                    ...
                                    effect.animatorAttributeSetter.animator =
                                        (RuntimeAnimatorController) EditorGUILayout.ObjectField(
                                            effect.animatorAttributeSetter.animator, typeof(RuntimeAnimatorController),
                                            false);
                                    ...
                                    if (EditorGUI.EndChangeCheck())
                                    {
                                        if (effect.animatorAttributeSetter.animator != null)
                                        {
                                            var str = AssetDatabase
                                                .GetAssetPath(effect.animatorAttributeSetter.animator)
                                                .Replace("Resources/", "¬");
                                            var strings = str.Split('¬');
                                            str = strings[1].Replace(".controller", "");
                                    ...
                                    GUILayout.Label("Name: ");
                                    effect.animatorAttributeSetter.name =
                                        EditorGUILayout.TextField(effect.animatorAttributeSetter.name);
                                    ...
                                    {
                                        case AnimatorControllerParameterType.Bool:
                                            var selected = effect.animatorAttributeSetter.setBool.ToString();
                                        ...
                                        case AnimatorControllerParameterType.Trigger:
                                            GUILayout.Label("Pull the trigger of [ " +
                                                            effect.animatorAttributeSetter.name + " ]");
                                            break;
                                    }
                                ...
                                case Effect.Type.EquipItem:
                                    ...
                                    if (EditorGUI.EndChangeCheck())
                                    {
                                        ...
                                        {
                                            if (DictionariesHelper.ContainsKey(item.name,
                                                    Controller.Instance.Options.currentLanguage).value == equipItemName)
                                            {
                                                effect.itemId = item.id;
                                                break;
                                            }
                                ...
                                case Effect.Type.SetGlobalFlag:
                                    ...
                                    effect.globalFlag.name = GUIHelper.Popup("Flag: ", effect.globalFlag.name,
                                        globalFlagsList);

                                    var effectSelected = effect.globalFlag.value.ToString();
                                ...
                                case Effect.Type.SetQuestState:
                                    ...
                                    if (quest != null)
                                    {
                                        ...
                                        if (EditorGUI.EndChangeCheck())
                                        {
                                            ...
                                            if (questStateIndex > -1)
                                            {
                                                effect.questAndState.questStateId =
                                                    QuestState.GetIDs(quest.questStates)[questStateIndex];
                                            }
                                        }
                                    }
                                ...
                                case Effect.Type.FinishQuest:
                                    // Get the quest name.
                                    var questToFinish = Quest.Find(Controller.Instance.Quests,
                                        effect.questAndState.questId);
                                    var questToFinishNameDict = questToFinish != null
                                        ? DictionariesHelper.ContainsKey(questToFinish.Name,
                                            Controller.Instance.Options.currentLanguage)
                                        : null;
                                    var questToFinishName = questToFinishNameDict != null
                                        ? questToFinishNameDict.value
                                        : string.Empty;

                                    // Quest Popup with a change checker.
                                    EditorGUI.BeginChangeCheck();
                                    var questToFinishNames = Quest.GetNames(Controller.Instance.Quests,
                                        Controller.Instance.Options);
                                    questToFinishNames = ArrayHelper.Add(questToFinishNames, string.Empty);
                                    questToFinishName =
                                        GUIHelper.Popup("Quest: ", questToFinishName, questToFinishNames);
                                    if (EditorGUI.EndChangeCheck())
                                    {
                                        var questIndex = ArrayHelper.GetIndex(
                                            Quest.GetNames(Controller.Instance.Quests, Controller.Instance.Options),
                                ...
                                case Effect.Type.StartQuest:
                                    // Get the quest name.
                                    var questToStart = Quest.Find(Controller.Instance.Quests,
                                        effect.questAndState.questId);
                                    var questToStartNameDict = questToStart != null
                                        ? DictionariesHelper.ContainsKey(questToStart.Name,
                                            Controller.Instance.Options.currentLanguage)
                                        : null;
                                    var questToStartName = questToStartNameDict != null
                                        ? questToStartNameDict.value
                                        : string.Empty;

                                    // Quest Popup with a change checker.
                                    EditorGUI.BeginChangeCheck();
                                    var questToStartNames = Quest.GetNames(Controller.Instance.Quests,
                                        Controller.Instance.Options);
            ...
            foreach (var localVariable in context.LocalVariables)
            {
                ...
                switch (localVariable.Type)
                {
                    case VariableType.String:
                        DictionariesHelper.ContainsKey(localVariable.StringValue,
                            Controller.Instance.Options.currentLanguage).value = EditorGUILayout.TextField(
                            DictionariesHelper.ContainsKey(localVariable.StringValue,
                                Controller.Instance.Options.currentLanguage).value,
                            GUILayout.Height(GUIHelper.BUTTON_HEIGHT_SMALL));
                        break;
                    case VariableType.Int:
                        localVariable.IntValue = EditorGUILayout.IntField(localVariable.IntValue,
                            GUILayout.Height(GUIHelper.BUTTON_HEIGHT_SMALL));
                        break;
            ...
            {
                context.AddLocalVariable(string.Format("variable{0}", context.LocalVariables.Length),
                    VariableType.String, string.Empty, Controller.Instance.Options.currentLanguage);
                Save();
            }
        ...
        private void UpdateItemList()
        {
            ...
            foreach (var item in Controller.Instance.Inventory.items)
            {
                itemList = ArrayHelper.Add(itemList,
                    DictionariesHelper.ContainsKey(item.name, Controller.Instance.Options.currentLanguage).value);
            }
        }
        ...
        private void UpdateMessagesList(Context context)
        {
            ...
            foreach (var col in context.columns)
            {
                ...
                {
                    var content =
                        DictionariesHelper.ContainsKey(msg.content, Controller.Instance.Options.currentLanguage);

                    if (content == null)
                    {
                        msg.content = ArrayHelper.Add(msg.content,
                            new LanguageDictionary(Controller.Instance.Options.currentLanguage, ""));
                        content = DictionariesHelper.ContainsKey(msg.content,
                            Controller.Instance.Options.currentLanguage);
                    }
        ...
        private void UpdateContextList()
        {
            ...
            foreach (var character in Controller.Instance.Characters)
            {
                ...
                {
                    var contextName =
                        DictionariesHelper.ContainsKey(context.name, Controller.Instance.Options.currentLanguage);
                    ...
                    if (contextName == null)
                    {
                        context.name = ArrayHelper.Add(context.name,
                            new LanguageDictionary(Controller.Instance.Options.currentLanguage,
                                "Name [Change clicking on Edit]"));
                        contextName = DictionariesHelper.ContainsKey(context.name,
                            Controller.Instance.Options.currentLanguage);
                    }
