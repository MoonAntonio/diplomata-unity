...
namespace LavaLeak.Diplomata.Editor.Windows
{
    public class InteractableListMenu : EditorWindow
    {
        ...
        {
            var window = (InteractableListMenu) GetWindow(typeof(InteractableListMenu), false, "Interactable List");
        ...
        public void OnGUI()
        {
            ...
            for (var i = 0; i < Controller.Instance.Options.interactableList.Length; i++)
            {
                ...
                if (GUILayout.Button("Delete", GUILayout.Height(GUIHelper.BUTTON_HEIGHT_SMALL)))
                {
                        ...
                        "Do you really want to delete?\nThis data will be lost forever.", "Yes", "No"))
                    {
                        ...
                        Controller.Instance.Options.interactableList =
                            ArrayHelper.Remove(Controller.Instance.Options.interactableList, name);
                        ...
                        Controller.Instance.Interactables =
                            InteractablesController.GetInteractables(Controller.Instance.Options);
