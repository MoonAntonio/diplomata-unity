...
namespace LavaLeak.Diplomata.Editor.Inspector
{
    ...
    public class DiplomataInteractableInspector : UnityEditor.Editor
    {
        ...
        private Interactable GetTalkable() => Interactable.Find(interactables, TalkableId.stringValue);
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (interactables.Count > 0)
            {
                ...
                {
                    InteractableEditor.Edit(
                        Interactable.Find(Controller.Instance.Interactables, TalkableId.stringValue));
                }
