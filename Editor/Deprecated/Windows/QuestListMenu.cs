...
namespace LavaLeak.Diplomata.Editor.Windows
{
    public class QuestListMenu : EditorWindow
    {
        ...
        {
            var window = (QuestListMenu) GetWindow(typeof(QuestListMenu), false, "Quests");
        ...
        public void OnGUI()
        {
            ...
            // Quests loop to list.
            foreach (var quest in Controller.Instance.Quests)
            {
            ...
            if (GUILayout.Button("Add Quest", GUILayout.Height(GUIHelper.BUTTON_HEIGHT)))
            {
                ...
                {
                    quest.questStates[0].ShortDescription = ArrayHelper.Add(quest.questStates[0].ShortDescription,
                        new LanguageDictionary(language, "in progress."));
                    quest.questStates[0].LongDescription = ArrayHelper.Add(quest.questStates[0].LongDescription,
                        new LanguageDictionary(language, ""));
                }
