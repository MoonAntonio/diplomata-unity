...
namespace LavaLeak.Diplomata.Editor.Windows
{
    public class InteractableEditor : EditorWindow
    {
        ...
        public static void Init(State state = State.None)
        {
            ...
            var window = (InteractableEditor) GetWindow(typeof(InteractableEditor), false, "Interactable", true);
        ...
        public void Create()
        {
            if (interactableName != "")
            {
                InteractablesController.AddInteractable(interactableName, Controller.Instance.Options,
                    Controller.Instance.Interactables);
            }
            else
            {
        ...
        public void DrawEditWindow()
        {
            ...
            var description =
                DictionariesHelper.ContainsKey(interactable.description, Controller.Instance.Options.currentLanguage);

            if (description == null)
            {
                interactable.description = ArrayHelper.Add(interactable.description,
                    new LanguageDictionary(Controller.Instance.Options.currentLanguage, ""));
                description = DictionariesHelper.ContainsKey(interactable.description,
