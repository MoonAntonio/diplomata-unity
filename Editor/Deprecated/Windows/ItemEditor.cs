...
namespace LavaLeak.Diplomata.Editor.Windows
{
    public class ItemEditor : EditorWindow
    {
        ...
        {
            var window = (ItemEditor) GetWindow(typeof(ItemEditor), false, "Item", true);
        ...
        public void DrawEditWindow()
        {
            ...
            var description =
                DictionariesHelper.ContainsKey(item.description, Controller.Instance.Options.currentLanguage);
            if (description == null)
            {
                item.description = ArrayHelper.Add(item.description,
            ...
            description.value = EditorGUILayout.TextArea(description.value, GUIHelper.textAreaStyle,
            ...
            EditorGUI.BeginChangeCheck();
            item.highlightImage =
                (Texture2D) EditorGUILayout.ObjectField(item.highlightImage, typeof(Texture2D), false);
            if (EditorGUI.EndChangeCheck())
            {
