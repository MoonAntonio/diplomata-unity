...
namespace LavaLeak.Diplomata.Editor.Controllers
{
    public static class InteractablesController
    {
        ...
        public static List<Interactable> UpdateList(Options options)
        {
            ...
            foreach (var obj in interactablesFiles)
            {
        ...
        private static void CheckRepeatedInteractable(Interactable interactable, Options options,
            List<Interactable> interactables)
        {
            var canAdd = true;

            foreach (var interactableName in options.interactableList)
            {
